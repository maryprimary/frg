...
#绘制示意图
#
from fermi.triangle import brillouin, dispersion, get_patches
...
def precompute(args):
    ...
    edges, pidxs = const_energy_line_in_patches(ltris, ladjs, lpats, 0.0, dispersion)
...
def main():
    ...
    parser = argparse.ArgumentParser(
        prog='python3 scripts/triangle/brillouin.py',
    ...
    parser.add_argument('--prefix', type=str,\
        default='scripts/triangle/tri', help='saved file prefix')
